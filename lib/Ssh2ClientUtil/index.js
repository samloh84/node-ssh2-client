...
/**
 * @callback Ssh2ClientUtilHostVerifierCallback
 * @param {String} hashedKey
 * @param {Ssh2ClientUtilHostVerifierCallbackCallback} callback - Call callback() with true or false for async verification.
 *
 */

/**
 * @callback Ssh2ClientUtilHostVerifierCallbackCallback
 * @param {Boolean} accept
 *
 */

/**
 * @callback Ssh2ClientUtilDebugCallback
 * @param {String} message
 *
 */

/**
 * @typedef {Object} Ssh2ClientUtilAlgorithmsOptions
 ...
 * @param {Ssh2ClientUtilHostVerifierCallback} options.hostVerifier
 ...
 * @param {Ssh2ClientUtilAlgorithmsOptions} options.algorithms
 * @param {Boolean} options.compress
 * @param {Boolean|Ssh2ClientUtilDebugCallback} options.debug
 *
 * @class Ssh2ClientUtil
 */
var Ssh2ClientUtil = function (options) {
...
Ssh2ClientUtil.consumeChannel = require('./consumeChannel');

_.assign(Ssh2ClientUtil.prototype, {
    _call: require('./_call'),
    ...
    getSftpUtil: require('./getSftpUtil'),
