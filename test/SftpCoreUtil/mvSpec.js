    ...
    describe("mv()", function () {
        ...
        describe("on a source file path with target file path", function () {
            ...
            it("should copy a file", function () {
                ...
                return sftpCoreUtil.mv({source: tempFile, destination: tempFileDestination})
                    .catch(function (err) {
                        console.error(err);
                        throw err;
                    })
        ...
        describe("on a source file path with target directory path", function () {
            ...
            it("should copy a file", function () {
                ...
                return sftpCoreUtil.mv({source: tempFile, destination: tempFileDestinationDir})
                    .catch(function (err) {
                        console.error(err);
                        throw err;
                    })
        ...
        describe("on a source directory path with target directory path and recursive = true", function () {
            ...
            it("should move a file tree", function () {
                ...
                return sftpCoreUtil.mv({source: tempWorkDir, destination: tempWorkDirDestination, recursive: true})
                    .catch(function (err) {
                        console.error(err);
                        throw err;
                    })
