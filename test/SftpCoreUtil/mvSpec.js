    ...
    describe("mv()", function () {
        ...
        describe("on a source file path with destination file path", function () {
            ...
            it("should move a file", function () {
                ...
                return sftpCoreUtil.mv({source: tempFile.path, destination: destinationPath})
                    .catch(function (err) {
                        console.error(err);
                        throw err;
                    })
        ...
        describe("on a source file path with destination directory path", function () {
            ...
            it("should move a file", function () {
                ...
                return sftpCoreUtil.mv({source: tempFile.path, destination: tempDestinationDir.path})
                    .catch(function (err) {
                        console.error(err);
                        throw err;
                    })
