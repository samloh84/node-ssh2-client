    ...
    describe("fchmod()", function () {
        ...
        beforeEach(function () {
            ...
            return ssh2Client.connect()
                ...
                .then(function () {
                    return sftpUtil.open({filename: tempFile, flags: 'w+'})
        ...
        it("should change the mode of a file", function () {
            ...
            return sftpUtil.fchmod({handle: tempFileFd, mode: SftpUtil.constants.S_IRWXU})
                .catch(function (err) {
                    console.error(err);
                    throw err;
                })
                ...
                .then(function () {
                    ...
                    (stats.mode & (parseInt(7777, 8))).should.be.equal(SftpUtil.constants.S_IRWXU);
                });
        });
    });
